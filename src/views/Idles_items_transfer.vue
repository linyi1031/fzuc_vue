      ...
      <div style="margin-top: 15px;margin-left:20.19%;margin-bottom:15px;background-color: white;border-radius: 30px;background-color: #eff3f7;width: 100%;position: relative">
          ...
          <div class="boxes">
            <div style="width: 100%">
              <div style="position:relative;">
                ...
                <span style="line-height: 34px;font-size: 25px;margin-left: 4%;position: absolute;margin-top: 1.5%">Hi! Do you want to sell something?</span>
              </div>
        ...
        <div class="right" style="width: 35%;float: right;position: absolute;top:140px;left: 63%;">
          ...
          <div>
            ...
            <div style="position: relative"><el-avatar :size="52" :src="circleUrl" style="margin-left: 2%;"></el-avatar>
