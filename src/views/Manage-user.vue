<template>
  <div id="app">
    <div id="nav" style="width: 16.5%;height: 1000px;background-color:#182a38;position: fixed;top: 4.1%;left: 0px;">
      ...
      <span style="color: white;text-align: left;font-size: 20px;margin-left: 2%;position: absolute;margin-top: 6%;font-weight: bold">FZU_Community</span><br>
      ...
      <el-menu
        ...
        <el-menu-item index="1" style="padding-left: 16%" @click="one">
        ...
        <el-menu-item index="3" style="padding-left: 16%" @click="thi">
          ...
          <span slot="title">Out-going management</span>
        </el-menu-item>
      </el-menu>
          ...
          <div>
            ...
            <el-menu
              ...
              <el-menu-item index="1" @click="home">
                <i class="el-icon-s-home" style="color: gray"></i>
...
export default {
  ...
  mounted() {
    ...
    this.config = {
      method: 'get',
      url: 'http://47.96.236.167:8080/statistics/article',
      headers: {
        'Content-Type': 'application/json',
        'token':localStorage.token
      },
    ...
    this.config = {
      method: 'get',
      url: 'http://47.96.236.167:8080/statistics/global',
      headers: {
        'Content-Type': 'application/json',
        'token':localStorage.token
      },
    ...
    this.config = {
      method: 'get',
      url: 'http://47.96.236.167:8080/statistics/login',
      headers: {
        'Content-Type': 'application/json',
        'token':localStorage.token
      },
    ...
    this.config = {
      method: 'get',
      url: 'http://47.96.236.167:8080/statistics/out',
      headers: {
        'Content-Type': 'application/json',
        'token':localStorage.token
      },
    ...
    this.config = {
      method: 'get',
      url: 'http://47.96.236.167:8080/statistics/online',
      headers: {
        'Content-Type': 'application/json',
        'token':localStorage.token
      },
