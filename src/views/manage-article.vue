              ...
              <el-table-column
                ...
                <template>
                  <el-button
                      size="mini"
                      type="danger"
                      @click="deleteA">delete</el-button>
                </template>
              </el-table-column>
            </el-table>
          </template>
...
export default {
  ...
  methods:{
    ...
    deleteA(){
      ...
      this.config = {
        method: 'get',
        url: 'http://47.96.236.167:8080/articles/manage/report/delete/'+_this.articleId,
        headers: {
          'Content-Type': 'application/json',
          'token':localStorage.token
        },
      ...
      axios(this.config).then(function(response) {
        _this.config = {
          method: 'get',
          url: 'http://47.96.236.167:8080//articles/manage/report/query',
          headers: {
            'Content-Type': 'application/json',
            'token':localStorage.token
          },
